...
- [x] T-520 レイアウト刷新: 案A+Bハイブリッド(2026-07-23。工程ステッパー+概要ダッシュボード+ページ分割。旧1600行の単一ページを共通シェル+概要+8工程ページへ分割。ヘッダーKPIバー・違反/警告バッジ・「次にやること」誘導。E2Eをステッパー巡回型に更新)
- [ ] T-521 グラフ描画(ポーラ曲線・質量内訳・スイープ散布図・梁の応力分布)。現状は表のみ
- [ ] T-522 2ペイン化(左入力・右結果即時更新)。案Cの画面内レイアウト
